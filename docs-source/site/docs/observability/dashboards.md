...
Details about Kafka brokers, topics, partitions, and consumers. For more details on Kafka monitoring configuration and metrics, see the [Kafka Observability Guide](./kafka.md).
